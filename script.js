...
var questions = [
    {
        question: "What is the correct way to abbreviate JavaScript?",
        answers: [
            {text: "js", score: 0, correct: false},
            {text: "Js", score: 0, correct: false},
            {text: "jS", score: 0, correct: false},
            {text: "JS", score: 5, correct: true}
        ]
    },
    {
        question: "What year did JavaScript come out?",
        answers: [
            {text: "1992", score: 0, correct: false},
            {text: "1990", score: 0, correct: false},
            {text: "1995", score: 5, correct: true},
            {text: "1999", score: 0, correct: false}
        ]
    },
    {
        question: "Who invented JavaScript?",
        answers: [
            {text: "Brendan Eich", score: 5, correct: true},
            {text: "Perry Northcutt", score: 0, correct: false},
            {text: "Keanu Reeves", score: 0, correct: false},
            {text: "Albert Einstein", score: 0, correct: false}
        ]
    },
    {
    ...
    {
        question: "True or False: JavaScript is the newest programming language?",
        answers: [
...
var displayHighScoreForm = function() {
    ...
    highScoreFormSection.innerHTML = "<h2>Add your score to the scoreboard!</h2>";
...
var resetQuiz = function() {
    ...
    // reset the title
    headingElement.textContent = "JavaScript Code Quiz";
